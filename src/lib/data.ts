...
export const experiencesData = [
  ...
  },
  {
    title: "IOS Developer",
    location: "303, Pham Van Dong street, Ward 1, District Go Vap, HCM City",
    description: "After this is as a ios developer for about more than 1 year in right this company.",
  ...
  {
    title: "Front-End Developer",
    location: "1007, Quang Trung street, Ward 10, District Go Vap, HCM City",
    description:
...
export const projectsData = [
  {
    ...
    description: "I worked as a ios developer on this startup project for about 1 years. This application can manage all the business processes of the restaurant, including human resource management.",
  ...
  },
  {
    title: "TTL Dashboard",
    description:
      "I worked as a front-end developer for about 2 year. Users can management products, orders, customer, affiliate and partner to website.",
    tags: ["React", "Redux Toolkit", "Tailwind", "Easy Email Editor", "Mantine Datatable", "Rest API"],
